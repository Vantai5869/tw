...
const AddressSelectRegister = ({ ...props }) => {
  ...
  useEffect(() => {
    if (suggestLocation.length > 0) {
      ...
      setAddress({
        ...
        latitude: suggestLocation[0].point.lattitude,
  ...
  const selectedAddress = (item: any) => {
    ...
    setAddress({
      name: item.address,
      latitude: item.point.lattittude,
  ...
  const selectByInput = (item: string) => {
    setModalSearch(false);
          ...
          <View>
            {province?.id ? (
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  ...
                  <Text style={{ color: colors.light_red }}>*</Text>
                </View>
                <Text
                  style={
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  <Text
                    style={
                      provinceSelected
                        ? styles.textTitlePick
                        : errorAddress
                        ? styles.textTitleError
                        : styles.textTitle
                    }
                  >
                    {translate("province")}
            ...
            {ward?.id ? (
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  <Text
                    style={
                      wardSelected ? styles.textTitlePick : styles.textTitle
                    }
                  >
                    {translate("ward")}
                  </Text>
            ...
            <View style={styles.formItem}>
              <View style={{ flexDirection: "row" }}>
                <Text
                  style={
                    errorAddress ? styles.textTitleError : styles.textTitle
                  }
                >
                  {translate("specific_address")}
                </Text>
                <Text style={{ color: colors.light_red }}>*</Text>
              </View>
              <TouchableOpacity
              ...
              >
                ...
                >
                  {address?.name
                    ? address?.name
                    : translate("insert_specific_address")}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
